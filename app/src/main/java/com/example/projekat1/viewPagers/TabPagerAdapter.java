...
import com.example.projekat1.fragments.ToDoFragment;
...
public class TabPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            ...
            break;
            case FRAG_NEW_1: fragment = new PlaceHolderFragment();//todo ima bug da su frag list i frag new zamenjeni, okrenuo sam brojeve tako da radi, ali je cudno
